    ...
    return (
        <div className="signup-container">
            ...
            <div className="continue-btns"> 
                ...
                <button onClick={handleGoogleAuth} className="continue-with"><img className="continue-with-img"src={pic1} alt="Google" /><p>Continue with Google</p></button>
                <br />
                {/* <button className="continue-with"><img className="continue-with-img"src={pic2} alt="LinkedIn" /><p>Continue with LinkedIn</p></button> */}
                {/* <br /> */}
                {/* <button onClick={handleGitHubLogin} className="continue-with"><img className="continue-with-img"src={pic3} alt="Github" /><p>Continue with Github</p></button> */}
                {/* <br /> */}
            </div>
        </div>
