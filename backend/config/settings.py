...
# =======
# >>>>>>> Stashed changes
SECRET_KEY = os.getenv('SECRET_KEY', 'nk5g!%ux&qfwhk%+!#_9aec@7*um_lx_9&e1^s*^+p7ylk9h0i')
...
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'codeverse.learning.platform.auth@gmail.com'
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = 'CodeVerse <codeverse.learning.platform.auth@gmail.com>'
