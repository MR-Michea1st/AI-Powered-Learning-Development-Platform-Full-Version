...
from .views import (CourseDetailView,UserEnrollmentCreateView,ListUserEnrollmentView,ProgressEnrollmentUpdateView,CourseListView,
                    ...
                    LessonDetailView,UserEnrollmentTrackCreateView,ListUserTrackEnrollmentView,ListUserInterviewsView,
                    TrackCourseViewSet)
...
urlpatterns = [
    ...
    path('interviews/',ListUserInterviewsView.as_view(),name='list-user-interviews'),
