...
class Track(models.Model) :
    ...
    thumbnail = models.ImageField(upload_to='tracks/thumbnails/' , default=None)
    status = models.CharField(max_length=4,choices=Status.choices,default=Status.PUBLISHED)
...
class Course(models.Model) :
    ...
    thumbnail = models.ImageField(upload_to='courses/thumbnails/' ,default=None)
...
class InterviewResults(models.Model):
    user_id = models.ForeignKey(to='users.User' , related_name='interviews_results' , on_delete=models.CASCADE)
    track_name = models.CharField(max_length=255 , default='')
    interview_result = models.TextField(max_length=10000)
    percentage_result=models.DecimalField(decimal_places=2 , max_digits=4)
    interviewed_at=models.DateField(auto_now=True)