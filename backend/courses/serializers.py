...
from courses.models import Track,Course,Section,CourseContent,Enrollment,TrackCourse,TrackEnrollment,InterviewResults
...
class InterviewResultsSerializer(serializers.ModelSerializer):
    
    class Meta:
        model=InterviewResults
        fields=[
            'id',
            'user_id',
            'track_name',
